        ...
        <article className="metrics">
            <div className="metrics__container metrics__container--first">
                ...
                <div className="metrics__card metrics__card--normal">
                    ...
                    <span className="metrics__previous">Prev: 22.7% (2017)</span>
                </div>
                <div className="metrics__card metrics__card--overall">
                    ...
                    <span className="metrics__previous metrics__previous--overall">Prev: 7.8 (2016)</span>
                </div>
                <div className="metrics__card metrics__card--overall">
                    ...
                    <span className="metrics__previous metrics__previous--overall">No Data (2016)</span>
                </div>
            </div>
        </article>
    );
