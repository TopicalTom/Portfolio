...
const Quotes = props => {
    ...
    return (
        ...
        >
            <ButtonNext 
                className="quotes__button quotes__button--right">
                <img 
                    className="quotes__icon--flip" 
                    src={chevron} 
                    alt=""
                />
            </ButtonNext>
            <ButtonBack 
                className="quotes__button quotes__button--left">
                <img 
