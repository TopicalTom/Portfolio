                    ...
                    <section className="project__content">
                        <Element 
                            ...
                            className="project__block">
                                ...
                                <Tag 
                                    ...
                                    color={color}
                                />
                                <p>TouchBase is a mobile app that allows for approachable networking through objective based conversation initiators and meetup scheduling within one's personal resume.</p>
                                <p>TouchBase builds on this core value by leveraging the newly introduced App Clips infrastructure in iOS 14 to enable spontaneous interactions through shareability of networking details with people outside of the app ecosystem.</p>
                                <Skip 
                                    links={links}
                        ...
                        <Element
                            ...
                            className="project__block">
                                ...
                                <p>While there are plenty of networking opportunities during an undergraduate degree, I always found myself on the side of the networking facilitators for events and less on the side of the networker. Due to this, the shift to communicating my value and story is a new experience that I was woefully unprepared for and is well outside my comfort zone.</p>
                        </Element>
                        <Takeaway 
                            type="OBSERVATION"
                        ...
                        <Element
                            ...
                            className="project__block">
                                ...
                                <p>My next step was understanding the dynamics of the networking experience and the underlying reasons for why networking feels draining and why people struggle to keep up with their connections.</p>
                                <p>To uncover these insights, I conducted three online interviews with people in my network that are early on in their career to understand their perspective and experiences trying to network in different fields.</p>
                        </Element>
                        <Element
                            className="project__block">
                                <h2>Uncovering the Issue</h2>
                                ...
                                <ul className="project__list">
                                    <li 
                                        ...
                                        There is a perception that being young and new to an industry means they don’t have much to offer.</li>
                                    <li 
                                        className="project__item">
                                        Talking to strangers can be awkward, scary and anxiety inducing as it relies on people exploring outside their comfort zone.</li>
                                    <li 
                                        className="project__item">
                                        Networking has a basis in trying to align oneself (or others) on the right path which isn’t limited to being new to an industry.</li>
                                    <li 
                                        className="project__item">
                                        People like doing research on the people they are networking with so they feel prepared and appear to have something to offer.</li>
                                </ul>
                                <Quotes
                                    size={quotes.length}
                                    quotes={quotes}
                        ...
                        <Element
                            className="project__block">
                                <h2>Different Stages, Similar Needs</h2>
                                <p>Using these quotes I was able to construct three approximate personas for the types of people that engage in networking which can be differentiated based on whether they are in an established place in their career, in flux, or entering:</p>
                                <PersonaCarousel 
                                    size={personas.length}
                                    persona={personas}
                                />
                                <p>Despite all being at different stages in their career, networking provides an avenue for each of them to progress their lifelong goals of their career. The disconnect for each of these personas comes from the uncertainty of knowing how to facilitate the “quid pro quo” in a way that feels shared and is maintained over an extended period in a meaningful and productive way.</p>
                        </Element>
                        <Element
                            className="project__block">
                                <h2>Outlining the Experience</h2>
                                <p>While each persona has their own individual issues with the networking experience, I focused on the perspective of Paulina (new persona) as they arguably have the most barriers to overcome due to being new to networking. The journey map of the new persona is as follows:</p>
                                <img 
                                    className="project__image"
                                    src={map}
                                    alt=""
                                />
                                <p>At a high-level, Paulina struggles with her confidence of her age and her perception of what she can bring to the table when interacting with people that are more seasoned. In order to appear well-versed Paulina conducts preliminary research on the people she interacts with, but has difficulties making the conversations extend beyond being surface level.</p>
                        </Element>
                        <Takeaway 
                            type="KEY TAKEAWAY"
                        ...
                        <Element
                            className="project__block">
                                ...
                                <p>Despite these drawbacks, we continue to use business cards as there is value in how little barriers there are between information being shared while also serving as a tangible reminder that an initial connection occurred.</p>
                        </Element>
                        <Element
                            className="project__block">
                        ...
                        <Element 
                            ...
                            className="project__block">
                                ...
                                <p>My focus for this initial experience was fostering the relationships we have of the people we run into and have hit it off.</p>
                                <p>For the next phase of this project I am going to be looking into the discovery aspect of networking and building out a feature that would allow users to search by specific content. This could be by background or even by the type of content users put as their call to action cards.</p>
                        </Element>
                        <Redirect 
                            link="/about"
                            cta="About Me"
