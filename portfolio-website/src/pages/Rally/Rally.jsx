            ...
            <main className="project">
                <div className="project__container">
                    ...
                    <section className="project__content">
                        ...
                        <Element
                            ...
                            className="project__block">
                                <Step 
                                    ...
                                    color={color}
                                />
                                <h2>Coordinating with Friends</h2>
                        ...
                        <Takeaway 
                            type="OBSERVATION"
                            details="Ensure local businesses that have persevered through these tough times have a chance to bounce back once social restrictions have lifted."
                            color={color}
                        />
                        <Element
                            name="Define"
                        ...
                        <Element
                            className="project__block">
                                ...
                                <p>A common frustration people had when making plans was with friends not following through with the plans they organized. This was largely due to moods changing and people dropping out between the time a plan was suggested, and when it was going to occur, since coordinating general availability and interest for a particular plan took too long.</p>
                        ...
                        <Element
                            className="project__block">
                                <h2>Passive & Active Engagement</h2>
                        ...
                        <Element 
                            ...
                            className="project__block">
                                <Step 
                                    ...
                                    color={color}
                                />
                                <h2>{`User & Development Barriers`}</h2>
                        ...
                        <Element 
                            className="project__block">
                                <h2>Leveraging the Hook Model</h2>
